...
def create_character(
    ...
    name: str,
    # description: Optional[str] = None, # Keep existing or remove? Let's comment out for now.
    # provider_id: Optional[str] = None, # provider_id seems TTS related, keep for now
    is_narrator: Optional[bool] = None,
    speaking: Optional[bool] = None,
    persona_description: Optional[str] = None,
    intro_text: Optional[str] = None,
    provider_id: Optional[str] = None # Keep provider_id for potential future use
) -> models.Character:
    db_character = models.Character(
        text_id=text_id, # Should be UUID, handle conversion if needed
        name=name,
        # description=description, # If needed, add back
